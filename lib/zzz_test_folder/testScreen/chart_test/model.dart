...
class SampleModel extends Listenable {
  ...
  void changeTheme(ThemeData currentThemeData, bool isMaterial3) {
    ...
    focusedColor = currentThemeData.colorScheme.onSurface.withOpacity(
      0.12,
    );
    splashColor = currentThemeData.colorScheme.onSurface.withOpacity(
      0.15,
    );
  }
...
Future<void> updateControlItems() async {
  if (!kIsWeb && (Platform.isWindows || Platform.isLinux || Platform.isMacOS)) {
    // await DesktopWindow.setMinWindowSize(const Size(775, 230));1
  }
