...
abstract class TradingSystemLocalDatasource {
...
class TradingSystemLocalDatasourceImpl implements TradingSystemLocalDatasource {
  TradingSystemLocalDatasourceImpl({required this.appPreferenceService});
